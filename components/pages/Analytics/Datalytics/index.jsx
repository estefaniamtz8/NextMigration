...
const Datalytics = () => {
  ...
  return (
    <div className="pb-10">
        ...
        <div className="flex w-72 gap-x-2 self-end rounded-lg border-[1px] border-solid border-gray bg-light-four px-2 py-2">
          <button
            ...
            className={`w-32 cursor-pointer rounded-lg border-none px-2 py-1 font-sans text-base font-light ${
              analyticsType === 'users' ? 'bg-white drop-shadow' : 'bg-transparent'
            }`}
          >
            Usuarios
          </button>
          <button
            ...
            className={`w-32 cursor-pointer rounded-lg border-none px-2 py-1 font-sans text-base font-light ${
              analyticsType === 'companies' ? 'bg-white drop-shadow' : 'bg-transparent'
            }`}
          >
            Empresas
          </button>
          <button
            ...
            className={`w-32 cursor-pointer rounded-lg border-none px-2 py-1 font-sans text-base font-light ${
              analyticsType === 'matches' ? 'bg-white drop-shadow' : 'bg-transparent'
            }`}
          >
            Matches
          </button>
      ...
      {analyticsType === 'users' && <UserAnalytics typeOfGraphs={typeOfGraphs} range={range} />}
      {analyticsType === 'companies' && <CompanyAnalytics typeOfGraphs={typeOfGraphs} range={range} />}
      {analyticsType === 'matches' && <MatchesAnalytics typeOfGraphs={typeOfGraphs} range={range} />}
    </div>
  );
};
