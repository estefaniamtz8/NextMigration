// components/ViableCbx.js
import React from 'react';
import { FormControl, MenuItem, Select } from '@mui/material';
import { useDispatch } from 'react-redux';
import { loader } from '../redux/actions/loader_actions'; // Ajusta esta importación según la estructura de tu proyecto
import { FontsData } from '../styles/palette'; // Ajusta esta importación según la estructura de tu proyecto

function ViableCbx({ state, userID, funct }) {
